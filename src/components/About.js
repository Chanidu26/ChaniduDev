      ...
      <div className="container mx-auto px-1 md:px-6 py-6">
        ...
        <div className="max-w-4xl py-5 mx-auto dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="px-4 md:px-6 py-6">
            <p className="dark:text-white text-md lg:text-lg leading-relaxed">
            ...
            <p className="mt-4 dark:text-white text-md lg:text-lg leading-relaxed">
            ...
            <p className='mt-4 dark:text-white text-md lg:text-lg leading-relaxed flex'>
             ...
             <p className='mt-4 dark:text-white text-md lg:text-lg leading-relaxed flex lg:ml-3'>
